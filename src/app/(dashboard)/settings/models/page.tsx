...
export default function ModelsManagerPage() {
    ...
    const handleRemoveModel = async (modelId: string) => {
        if (!confirm("¿Estás seguro de que quieres eliminar este modelo? Deberás descargarlo de nuevo para usar sus funciones.")) return;
    ...
    const models = [
        ...
        },
        {
            ...
            description: 'Cerebro principal para redacción científica y análisis complejo.',
            size: '4.9 GB',
        ...
        },
        {
            ...
            description: 'Modelo optimizado para equipos con poca RAM o tareas rápidas.',
            size: '2.3 GB',
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-zinc-500 uppercase font-bold">RAM Total</p>
                ...
                <div className="bg-white dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-zinc-500 uppercase font-bold">Núcleos CPU</p>
                ...
                <div className="bg-white dark:bg-zinc-900 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 flex items-center gap-3">
                    <div className={cn(
                        "p-2 rounded-lg",
                        mirrorOnline ? "bg-emerald-50 text-emerald-600 dark:bg-emerald-900/20" : "bg-amber-50 text-amber-600 dark:bg-amber-900/20"
                    )}>
                        <Zap size={20} />
                    </div>
                    <div>
                        <p className="text-[10px] text-zinc-500 uppercase font-bold">Estado Espejo</p>
                        <p className="text-sm font-bold">{mirrorOnline ? "Online (Rápido)" : "Offline (HuggingFace)"}</p>
                    </div>
                </div>
            </div>
                ...
                {models.map((model) => (
                    <div 
                        ...
                        className={cn(
                            ...
                            model.ready ? "border-emerald-100 dark:border-emerald-900/30" : "border-zinc-200 dark:border-zinc-800"
                        )}
                    >
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="flex flex-col gap-2 min-w-[140px]">
                                {model.ready ? (
                                    ...
                                    >
                                        {downloading === model.id ? <Loader2 size={14} className="animate-spin" /> : <Download size={14} />}
            ...
            <div className="p-4 bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/30 rounded-xl flex gap-3 items-start text-xs text-amber-800 dark:text-amber-200 leading-relaxed">
                ...
                <p>
                    <strong>Nota Importante:</strong> La descarga de modelos puede tardar varios minutos dependiendo de tu conexión a internet. No cierres la aplicación hasta que la barra de progreso finalice. Los modelos se guardan en tu carpeta de datos local para máxima privacidad.
                </p>
            </div>
        </div>
    );
